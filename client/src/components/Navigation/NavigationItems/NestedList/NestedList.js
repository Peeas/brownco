      ...
      className={classes.root}>
        ...
        <Collapse in={open} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
                ...
                <ListItem onClick={() => handleNav('/structural-steel')} button className={classes.nested}>
                    <ListItemText primary="Structural Steel" />
                </ListItem>

                <ListItem onClick={() => handleNav('/concrete-construction')} button className={classes.nested}>
                    <ListItemText primary="Concrete Construction" />
                </ListItem>

                <ListItem onClick={() => handleNav('/demolition-excavation')} button className={classes.nested}>
                    <ListItemText primary="Demolition Excavation" />
                </ListItem>

                <ListItem onClick={() => handleNav('/renewable-resources')} button className={classes.nested}>
                    <ListItemText primary="Renewable Resource" />
                </ListItem>

                <ListItem onClick={() => handleNav('/tenant-improvement')} button className={classes.nested}>
