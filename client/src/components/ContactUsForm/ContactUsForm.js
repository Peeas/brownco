...
class ContactUsForm extends Component {
  ...
  render() {
    ...
    if (this.state.showSuccess) {
      notification = <div className={classes.Notification}>Email Sent!</div>;
    }
          ...
          <div>
            <form
              ...
              <div className={classes.FormRow}>
                <FormControl variant='filled' className={classes.longField}>
                  ...
                  <Select
                    ...
                    <MenuItem value={'structural steel'}>
                      Structural Steel
                    </MenuItem>
                    <MenuItem value={'concrete construction'}>
                      Concrete Construction
                    </MenuItem>
                    <MenuItem value={'demolition excavation'}>
                      Demolition Excavation
                    </MenuItem>
                    <MenuItem value={'renewable resources'}>
                      Renewable Resources
                    </MenuItem>
                    <MenuItem value={'tenant improvement'}>
                      Tenant Improvement
                    </MenuItem>
              ...
              <div className={classes.BtnRow}>
                <button className={classes.CommonButton} type='submit'>
                  Send
                </button>
              </div>
            </form>
